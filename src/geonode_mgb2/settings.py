...
try:
    from geonode_mgb2.local_settings import *
...
#
PROJECT_NAME = 'geonode_mgb2'

# add trailing slash to site url. geoserver url will be relative to this
if not SITEURL.endswith('/'):
    SITEURL = '{}/'.format(SITEURL)

SITENAME = os.getenv("SITENAME", 'geonode_mgb2')
...
if PROJECT_NAME not in INSTALLED_APPS:
    # Adicionado o app mgb2 em settings
    INSTALLED_APPS += (PROJECT_NAME, "mgb2") 
