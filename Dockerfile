...
RUN mkdir -p /usr/src/geonode_mgb2
...
COPY src /usr/src/geonode_mgb2/
WORKDIR /usr/src/geonode_mgb2
...
RUN chmod +x /usr/src/geonode_mgb2/tasks.py \
    && chmod +x /usr/src/geonode_mgb2/entrypoint.sh
...
# ENTRYPOINT /usr/src/geonode_mgb2/entrypoint.sh
